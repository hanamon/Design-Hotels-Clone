	...
	navBtnEvent: function(){
		$('.navBtn').each(function(index){
			$(this).on({
				click: function(){
					if( index == 0 ){
						location.href = '/Project-2019/Design-Hotels-Clone/gn53/bbs/board.php?bo_table=DHFreeboard';
					}
					else if( index == 1 ){
						location.href = '/Project-2019/Design-Hotels-Clone/main/main2';
					}
					else if( index == 2 ){
						window.open('/Project-2019/Design-Hotels-Clone/main/main3', '_blank');
					}
					else if( index == 3 ){
						location.href = '/Project-2019/Design-Hotels-Clone/main/main4/main4-1';
					}
					else if( index == 4 ){
						location.href = '/Project-2019/Design-Hotels-Clone/main/main5';
					}
					else if( index == 5 ){
						window.open('/Project-2019/Design-Hotels-Clone/main/main6', '_blank'); 
					}
				}
			});
		});
		$('.logoBtn').on({
			click: function(){
				location.href = '/Project-2019/Design-Hotels-Clone';
			}
		});
